...
const currentUserAnalyticsPath = computed(() => authStore.user?.id ? `/analytics/user/${authStore.user.id}` : '/analytics')
...
<template>
  <div class="user-page">
    <nav class="user-nav"><router-link to="/dashboard" class="brand"><span class="mark-icon">B</span><span>BridgeOS</span></router-link><div class="nav-links"><div class="scope-switch" aria-label="Analytics scope"><router-link to="/analytics" class="scope-option">Project</router-link><router-link :to="currentUserAnalyticsPath" class="scope-option active">Personal</router-link></div><router-link to="/decisions">Decisions</router-link></div><button type="button" @click="logout">Log out</button></nav>
